...
export const metadata: Metadata = {
  title: "Pricing — Tesda Nc Premium",
  description: "Unlock unlimited Tesda Nc practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=tesda-nc&cadence=annual`;
